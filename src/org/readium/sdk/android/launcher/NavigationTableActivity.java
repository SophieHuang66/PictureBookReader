...
import com.fsm.storybook.launcher.WebViewActivity;
        ...
        view.setOnItemClickListener(new ListView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
            	...
            	if (navigation instanceof NavigationPoint) {
            		...
            		// return selected item url instead of open it directly
            		...
            		Intent i = new Intent();
            		Bundle b = new Bundle();
            		b.putString(Constants.SELECTED_ITEM, point.getContent());
            		i.putExtras(b);
